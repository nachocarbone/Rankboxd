...
function holGameOver() {
  ...
  const memes = [
    // Racha 0-3: decepción / amateur
    {
      min: 0, max: 3,
      gifs: [
        { url: 'https://media.giphy.com/media/l1J9EdzfOSgfyueLm/giphy.gif', caption: 'bro really tried' },
        { url: 'https://media.giphy.com/media/3o7TKMt1VVNkHV2PaE/giphy.gif', caption: 'disappointing' },
      ]
    },
    // Racha 4-7: no está mal
    {
      min: 4, max: 7,
      gifs: [
        { url: 'https://media.giphy.com/media/l0MYGb1LuZ3n7dRnO/giphy.gif', caption: 'not bad, not bad...' },
        { url: 'https://media.giphy.com/media/xT9IgG50Lg7russbCS/giphy.gif', caption: 'I see potential' },
      ]
    },
    // Racha 8-14: Patrick Bateman — respetable, sigma
    {
      min: 8, max: 14,
      gifs: [
        { url: 'https://media.giphy.com/media/gzvOJKceEQZ2cM8Dl5/giphy.gif', caption: 'Patrick Bateman approves' },
        { url: 'https://media.giphy.com/media/LqxGNzaIAMDFm/giphy.gif', caption: 'this is impressive' },
      ]
    },
    // Racha 15-24: DiCaprio pointing — eso sí que es
    {
      min: 15, max: 24,
      gifs: [
        { url: 'https://media.giphy.com/media/kd9BlRovbPOykLBMqX/giphy.gif', caption: 'THAT\'S the one' },
        { url: 'https://media.giphy.com/media/5GoVLqeAOo6PK/giphy.gif', caption: 'leo is proud of you' },
      ]
    },
    // Racha 25+: leyenda absoluta
    {
      min: 25, max: Infinity,
      gifs: [
        { url: 'https://media.giphy.com/media/NnGGHE0muVqpdu6LRV/giphy.gif', caption: 'you are built different' },
        { url: 'https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif', caption: 'absolute cinema connoisseur' },
      ]
    },
  ];
  ...
  if (tier) {
    ...
    document.getElementById('holMemeCaption').textContent = pick.caption;
