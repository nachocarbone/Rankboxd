...
function holRenderCards() {
  // Left card — always shows rating
...
function holChoose(choice) {
  ...
  // Reveal right rating
  const ratingEl = document.getElementById('holRatingB') || document.createElement('div');
  // Create rating display under title
  ...
  if (!revealEl) {
    ...
    revealEl.className = 'holRating';
    cardBInfo.appendChild(revealEl);
  }
